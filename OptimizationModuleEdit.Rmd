...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 1: Extreme Values", fig.alt="A graph showing local maxima and minima on a function."}
...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 2: Fermat's Theorem: local extrema occur at points where the tangent line is horizontal or at endpoints of the domain. Some local extrema are also global extrema.", fig.alt="A graph showing local maxima and minima at which horizontal tangents occur on a function."}
...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 3: Graph of $f(x) = x^2+3x-2$ (Example 1) ", fig.alt="Graph of $f(x) = x^2+3x-2$ shown on an axis."}
...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 4: Graph of $f(x) = 3x^4-4x^3-54x^2+108x$  (Example 2) ", fig.alt="Graph of $f(x) = 3x^4-4x^3-54x^2+108x$ shown on an axis."}
...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 5: Finding a line of best fit", fig.alt="Points on a plane and potential best fits lines are graphed."}
...
```{r, echo=FALSE, out.height="50%", fig.cap="Figure 6: Finding a line of best fit through the origin (Example 3)", fig.alt="Defining error between points and other points that rest on the line of best fit."}
...
```{r plot-iris-dataset, fig.cap="Figure 7: Dataset: Sepal Length vs Petal Width", fig.alt = "Graphical representation of 'Dataset: Sepal Length vs Petal Width'.", echo = TRUE}
...
```{r plot-linear_regression_iris_dataset, fig.cap="Figure 8: Dataset: Sepal Length vs Petal Width, with best-fit line", fig.alt = "Graphical representation of 'Dataset: Sepal Length vs Petal Width' with a line of best fit.", echo = TRUE}
plot(iris$Sepal.Length~iris$Petal.Width, xlab = "Petal Width", ylab = "Sepal Length")
...
```{r plot-Michaelis-Menten-dataset, fig.cap="Figure 9: Dataset: reaction velocity against substrate concentration", fig.alt = "Graphical representation of 'Dataset: reaction velocity against substrate concentration' which contain points following a logarithmic function.", echo = TRUE}
...
```{r plot_nonlinear_regression_Michaelis-Menten_dataset, fig.cap="Figure 10: Dataset: reaction velocity against substrate concentration and best-fit model", fig.alt = "Graphical representation of 'Dataset: reaction velocity against substrate concentration' with a line of best fit showing a logarithmic pattern.",echo = TRUE}
plot(MM_data)
...
```{r plot-wireframe-convex-function, fig.cap="Figure 11: Surface plot of a paraboloid", fig.alt="Surface plot of paraboloid shown on a square domain.",echo=FALSE,message=FALSE}
...
```{r gradient-descent-convex-function-plot-paths, fig.cap="Figure 12: Search paths on paraboloid surface", fig.alt="Search paths on paraboloid surface are shown in lines as they follow four distinct points.", echo=FALSE}
...
```{r plot-wireframe-complicated-function, fig.cap="Figure 13: Surface plot with multiple minima", fig.alt="This figure shows a surface plot with multiple minima plotted on a square domain.", echo=FALSE,message=FALSE}
...
```{r plot-surface-complicated-function,fig.cap="Figure 14: Interactive surface plot with multiple minima", fig.alt="This figure shows an interactive version of Figure 13.", echo=FALSE,message=FALSE,warning=FALSE}
library(MASS)
library(plotly)
x <- seq(-4, 4, length= 30)
y <- seq(-4, 4, length= 30)
...
```{r gradient-descent-plot-paths-complicated-function, fig.cap="Figure 15: Surface plot with multiple minima and search paths", fig.alt="This figure shows a downwards perspective of Figure 13 with search paths following several points.", echo=FALSE}
...
```{r exercise-1-dataset2, fig.cap="Figure 16: Drug concentration data for exercise 1", fig.alt="This figure shows a graph with a downwards trend showing that drug concentration decreases over time.", echo = TRUE}
...
```{r plot-wireframe-egg-carton-function, fig.cap="Figure 17: Surface plot with many minima, resembling an egg carton", fig.alt="This figure shows a surface plot with many minima, resembling an egg carton in a square domain.", echo=FALSE}
f.name <- "Example 9"
...
```{r plot-egg-carton-simulated-annealing-traces,fig.cap="Figure 18: Progress of simulated annealing algorithm", fig.alt="This figure shows the progress of simulated annealing algorithm in a graph.", echo=FALSE}
...
```{r report-summary-GA, fig.cap="Figure 19: Progress of genetic algorithm", fig.alt="This graph shows that the genetic algorithm matches the solution by displaying the mean and the line of best fit (which both have a similar exponential trend).",echo=TRUE}
summary(ga)
```
...
```{r simulate-and-plot-lotka-volterra, fig.cap="Figure 20: Simulation of Lotka-Volterra system.", fig.alt="This figure shows a graph comparing time and population density between predator and prey.", echo = TRUE, warning = FALSE}
library(deSolve)
...
```{r generate-and-plot-lotka-volterra-corrupted-data, fig.cap="Figure 21: Data for Lotka-Volterra system.", fig.alt="This figure shows the plots used for Figure 20.", echo = FALSE, warning = FALSE}
...
```{r plot-lotka-volterra-best-fit-and-data, fig.cap="Figure 22: Data for Lotka-Volterra system and best-fit simulation.", fig.alt="This figure shows the combination of Figure 20 and 21.", echo = FALSE, warning = FALSE}
...
```{r exercise-3-generate-lotka-volterra-corrupted-data, fig.cap="Figure 23: Data for Lotka-Volterra system for exercise 3", fig.alt="This figure shows plots on a graph representing predator and prey population density vs. time.", echo = FALSE, warning = FALSE}
...
```{r plot-prediction-confidence-intervals-linear-regression-iris, fig.cap="Figure 24: Prediction confidence intervals of linear regression fit.", fig.alt="This figure shows plots on a graph with x-axis 'Sepal Length' and y-axis 'Petal Width' and a line of best fit with two additional lines representing the parameters of the confidence intervals.", echo=TRUE}
...
```{r 2plot-Michaelis-Menten-dataset, fig.cap="Figure 25: Nonlinear regression fit from example 5", fig.alt="This figure shows plots with a logarithmic line of best fit.", echo = TRUE}
#substrate concentrations
S <- c(4.32, 2.16, 1.08, 0.54, 0.27, 0.135, 3.6, 1.8, 0.9, 0.45, 0.225, 0.1125, 2.88, 1.44, 0.72, 0.36, 0.18, 0.9, 0)
#reaction velocities
V <- c(0.48, 0.42, 0.36, 0.26, 0.17, 0.11, 0.44, 0.47, 0.39, 0.29, 0.18, 0.12, 0.50, 0.45, 0.37, 0.28, 0.19, 0.31, 0)
...
```{r plot-rejection-histograms, fig.cap="Figure 26: Posterior histograms for Michaelis-Menten fit.", fig.alt="This figure shows a histogram demonstrating Km vs. Frequency.", echo=FALSE}
...
```{r exercise-1-dataset, fig.cap="Figure 27: Exercise 1 showing decreasing drug concentration", fig.alt="This figure shows drug concentration in blood over time as plots that follow a decreasing trend.", echo = TRUE}
...
```{r exercise_1_nls_exp_soln, fig.cap="Figure 28: Exercise 1 data decreasing drug concentration with expoential fit.", fig.alt="This figure shows the fitted exponential line of best fit as the solution.", echo = FALSE}
...
```{r exercise_1_nls_biexp_soln, fig.cap="Figure 29: Exercise 1 data decreasing drug concentration with biexponetial fit.", fig.alt="This figure shows the fitted biexponential line of best fit as the solution.", echo = FALSE}
...
```{r exercise-1-grad-descent_exp-soln, fig.cap="Figure 30: Exercise 1 data decreasing drug concentration with expoential fit gradient descent", fig.alt="This figure shows the fitted exponential with gradient descent, as the line of best fit, as the solution.", echo = TRUE}
x0 = c(5.5,-0.01)
...
```{r exercise-1-grad-descent-biexp_soln, fig.cap="Figure 31: Exercise 1 data decreasing drug concentration with biexponetial fit gradient descent", fig.alt="This figure shows the fitted biexponential with gradient descent, as the line of best fit, as the solution", echo = TRUE}
x0 = c(3,-0.03,3,-0.06)
...
```{r ex2-results, fig.cap="Figure 32: Exercise 2 genetic algorithm progress", fig.alt="This figure shows the line of best fit and mean on a graph with x-axis 'Generation' and y-axis 'Fitness value' obtained through simulated annealing.", echo = TRUE}
plot(ga1)
summary(ga1)
```
...
```{r ex4_plot-rejection-histograms, fig.cap="Figure 33: Exercise 4 posterior histograms", fig.alt="These figures show histograms that show very small bars for the x-direction and wider spread bars for the y-direction.", echo=FALSE}
c1 <- rgb(173,216,230,max = 255, alpha = 80, names = "lt.blue")
c2 <- rgb(255,192,203, max = 255, alpha = 80, names = "lt.pink")
