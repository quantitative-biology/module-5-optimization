...
obsplot<-plot(observations[,3]~observations[,1], col = "red", ylim = c(0,20), main = "Observations of a Predator-Prey Population System", xlab = "Time", ylab = "Population Density", pch = 20)
points(observations[,2]~observations[,1], add = TRUE, pch = 20)
