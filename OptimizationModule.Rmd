...
knitr::include_graphics("../module-5-optimization/Figure1.png")
```
...
knitr::include_graphics("../module-5-optimization/Figure2.png")
```
...
knitr::include_graphics("../module-5-optimization/Figure3.png")
```
...
knitr::include_graphics("../module-5-optimization/Figure4.png")
```
...
knitr::include_graphics("../module-5-optimization/Figure5.png")
```
...
knitr::include_graphics("../module-5-optimization/Figure6.png")
```
...
```{r exercise-1-dataset, fig.alt="Drug concentration data for exercise 1", echo = TRUE}
