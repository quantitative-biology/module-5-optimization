...
```{r plot-linear_regression_iris_dataset, fig.cap="Sepal Length vs Petal Width from the iris dataset, with best-fit line", fig.alt = "A scatterplot of Sepal Length vs Petal Width for each observation with an upward trending line superimposed", echo = TRUE}
plot(iris$Sepal.Length~iris$Petal.Width, xlab = "Petal Width", ylab = "Sepal Length")
...
```{r plot_nonlinear_regression_Michaelis-Menten_dataset, fig.cap="Reaction velocity against substrate concentration dataset, with best-fit line", fig.alt = "A scatterplot of velocity vs substrate concentration for each observation with a logarithmic trending line superimposed.",echo = TRUE}
plot(MM_data)
...
```{r exercise-1-grad-descent_exp-soln, fig.cap="Exercise 1 data decreasing drug concentration with expoential fit gradient descent", fig.alt="Fitted exponential with gradient descent, as the line of best fit, as the solution is superimposed.", echo = TRUE}
x0 = c(5.5,-0.01)
