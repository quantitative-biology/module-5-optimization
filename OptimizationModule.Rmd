...
<p><center>
`r htmltools::img(src=knitr::image_uri("Desktop/Figure1.png"))`  
...
<p><center>
`r htmltools::img(src=knitr::image_uri("Desktop/Figure2.png"))`  
...
<p><center>
`r htmltools::img(src=knitr::image_uri("Desktop/Figure3.png"))`  
...
<p><center>
`r htmltools::img(src=knitr::image_uri("Desktop/Figure4.png"))`  
Figure 4: Example graph of $f(x) = 3x^4-4x^3-54x^2+108x$  
</center></p>

<p><center>
`r htmltools::img(src=knitr::image_uri("Desktop/Figure5.png"))`  
