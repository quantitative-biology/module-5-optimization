...
lower <- c(0.1,0.1)
upper <- c(10,10)
out0 <- GenSA(par = x1, lower = lower, upper = upper,fn = determine_sse2, control = list(maxit = 200))
out0[c("value","par")]
```
