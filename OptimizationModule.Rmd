...
<p><center>
`r htmltools::img(src=knitr::image_uri("../module-5-optimization/Figure1.png"))`
...
<p><center>
`r htmltools::img(src=knitr::image_uri("../module-5-optimization/Figure2.png"))`
...
<p><center>
`r htmltools::img(src=knitr::image_uri("../module-5-optimization/Figure3.png"))`
...
<p><center>
`r htmltools::img(src=knitr::image_uri("../module-5-optimization/Figure4.png"))`
Figure 4: Example graph of $f(x) = 3x^4-4x^3-54x^2+108x$
</center></p>

<p><center>
`r htmltools::img(src=knitr::image_uri("../module-5-optimization/Figure5.png"))`
...
# 4 Calibration of Dynamic Models
...
## 5.2 Uncertainty Analysis and Bayesian Approahces
...
## 5.4 Optimal distribution of intracellular metabolic fluxes (Flux Balance Analysis)
