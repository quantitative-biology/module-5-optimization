...
#### Example 4
<p> To give the simulated annealing algorithm a more challenging task, consider the following function, which has many local minima. </p>
...
<p> Example: maybe biexponential or not, depending on complexity of cost surface. </p>
