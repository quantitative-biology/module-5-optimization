...
prior1 <- hist(sampled_parameter_values_squared_distances[1:1200,2],col = c1,
               xlab = "K", main="Prior Versus Posterior Distribution for K") 
post1 <- hist(sampled_parameter_values_squared_distances[which(sampled_parameter_values_squared_distances$accepted_or_rejected==1),2], col=c2, xlab = "K", add=TRUE)
legend("bottomright",legend=c("Prior Distribution for K", "Posterior Distribution for K"),
       inset=.02, fill=c(c1,c2), cex=0.8)
prior2 = hist(sampled_parameter_values_squared_distances[1:1200,3],col = c1,
              xlab = "Vm", main="Prior Distribution for Vm") 
post2 = hist(sampled_parameter_values_squared_distances[which(sampled_parameter_values_squared_distances$accepted_or_rejected==1),3],col = c2, xlab = "Vm", add=TRUE)
